  ...
  return (
    <div className='hero-bg relative'>
      ...
      <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
        ...
        <Link to={"/login"} className='text-white bg-red-600 px-4 py-2 rounded'>
          Sign In
        </Link>
      </header>
      ...
      <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
        ...
        <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFromSubmit}>
          ...
          />
          <button className='bg-red-600 text-xl lg:text-2xl px-4 py-2 rounded flex items-center'>
            Get Started
          ...
          <div className='flex-1'>
            <div className='relative'>
              ...
              <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2'>
                <img src="/stranger-things-sm.png" alt="Poster" className='h-full' />
  ...
  <div className='py-10 bg-black text-white'>
    <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
      ...
      <div className='flex-1 relative overflow-hidden'>
        <img src='/device-pile.png' alt='TV' className='mt-4 z-20 relative' />
        <video
